const Footer = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-0 border-b-[1.7rem] border-l-[1.7rem] border-r-[1.7rem] border-custom2 bg-custom1 fixed left-0 right-0 bottom-0 px-14 py-5">
      <div>
        <small className="text-gray-400">
          © 2023 Shamim. All rights reserved.
        </small>
      </div>
